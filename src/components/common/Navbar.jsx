...
const Navbar = () => {
    ...
    const fetchSublinks = async () => {
        try {
            console.log("📡 CATEGORIES_API URL:", categories.CATEGORIES_API);

            const result = await apiConnector(categories.CATEGORIES_API, "GET");

            console.log("🚀 API Response:", result);
    
            if (result?.data?.data) {
                setSubLinks(result.data.data);
                console.log("📊 SubLinks State:", result.data.data); 
            } else {
